...
@Injectable()
export class LifoStrategy implements InventoryReleaseStrategy {
  ...
  async selectBatches(
    ...
    // Sort by createdAt DESC (LIFO)
    candidates.sort((a, b) => b.batch.createdAt.getTime() - a.batch.createdAt.getTime());
